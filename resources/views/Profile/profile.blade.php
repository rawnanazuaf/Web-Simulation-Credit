      ...
      <form action="/user/{{auth()->user()->id}}/profile" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control form-control-rounded" name="md_username" id="md_username"
                placeholder="Enter User Id" value="{{auth()->user()->username}}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group py-2">
            <div class="icheck-material-white">
                ...
                <label for="user-checkbox2">Saya Setuju Untuk Merubah Password</label>
            </div>
        </div>
        <div class="form-group">
            <button type="submit" class="btn btn-warning"><i class="icon-lock"></i>Ubah
                Password
            </button>
        </div>
      </form>
...
<!--         
        ...
        @if(Auth::user()->role != 4)
        <a href="/index" class="btn btn-dark">Back to Menu</a>
        @endif
        @if(Auth::user()->role == 4)
        <a href="/kalkulator" class="btn btn-dark">Back to Calculator</a>
        @endif
        <!-- <li>
...
<style>
  ...
  body {
    background: url("dashboard/assets/images/login_bg.png") no-repeat center center fixed;
